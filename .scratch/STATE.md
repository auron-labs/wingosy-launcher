...
| Effort | Ticket | Type | Mode | Status | Blocked by |
| --- | --- | --- | --- | --- | --- |
| [transparent-romm-launching](transparent-romm-launching) | [01-atomic-romm-downloads](transparent-romm-launching/issues/01-atomic-romm-downloads.md) | — | — | resolved | None — can start immediately. |
| [transparent-romm-launching](transparent-romm-launching) | [02-unified-local-cached-play](transparent-romm-launching/issues/02-unified-local-cached-play.md) | — | — | resolved | 01 — Make manual RomM downloads atomic. |
| [transparent-romm-launching](transparent-romm-launching) | [03-one-click-remote-play-desktop](transparent-romm-launching/issues/03-one-click-remote-play-desktop.md) | — | — | resolved | 02 — Route local and cached games through one Play pipeline. |
| [transparent-romm-launching](transparent-romm-launching) | [04-controller-remote-play-flow](transparent-romm-launching/issues/04-controller-remote-play-flow.md) | — | — | resolved | 03 — Enable one-click remote Play on desktop. |
| [transparent-romm-launching](transparent-romm-launching) | [05-reliable-retroarch-nes](transparent-romm-launching/issues/05-reliable-retroarch-nes.md) | — | — | resolved | 04 — Enable the controller-only remote Play flow. |
| [transparent-romm-launching](transparent-romm-launching) | [06-retroarch-snes-genesis](transparent-romm-launching/issues/06-retroarch-snes-genesis.md) | — | — | resolved | 05 — Establish the reliable RetroArch NES slice. |
