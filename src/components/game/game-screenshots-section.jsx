  ...
  <Box sx={{ mb: 3 }}>
    ...
    <Typography color="text.secondary" sx={{ lineHeight: 1.7 }} variant="body2">
      {isRommGame ? (
        ...
        <>
          Screenshots here come from RomM metadata. Games added only from a
          local folder don’t have a RomM gallery yet.
        </>
      )}
    </Typography>
  </Box>
 ...
 * @param {object} props Screenshot section properties.
