...
const GameCredits = ({ game }) => {
  ...
  return (
    <Box sx={{ display: "flex", gap: 4, mb: 3 }}>
      {game.developer && <Credit label="Developer" value={game.developer} />}
      {game.publisher && <Credit label="Publisher" value={game.publisher} />}
    </Box>
  );
};

/** @param {{label: string, value: string}} props Credit properties. */
