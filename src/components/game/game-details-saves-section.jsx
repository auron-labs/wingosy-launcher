...
/**
 * @param {{isSwitch: boolean, savesLoaded: boolean, savesLoading: boolean, switchSyncBusy: boolean, switchRestoreProtection: GameDetailsSwitchSaveRestoreProtection|null, onListSaves: () => Promise<void>, onUploadSwitchSave: () => Promise<void>, onDownloadSwitchSave: () => Promise<void>, onResumeSwitchSaveNormalSync: () => Promise<void>, onUploadSave: () => Promise<void>}} props Save actions and state.
 */
const SaveControls = ({
  isSwitch,
...
/** @param {{protection: GameDetailsSwitchSaveRestoreProtection}} props Protected revision properties. */
const SwitchRestoreProtectionNotice = ({ protection }) => {
...
/** @typedef {{game: GameDetailsGame, isSwitch: boolean, rommToken: string|null, rommUrl: string|null, saves: GameDetailsSave[], savesLoaded: boolean, savesLoading: boolean, saveStatus: GameDetailsStatus|null, switchSlot: string, setSwitchSlot: (value: string) => void, switchPathInfo: GameDetailsSwitchPathInfo|null, switchRestoreProtection: GameDetailsSwitchSaveRestoreProtection|null, switchSyncBusy: boolean, onListSaves: () => Promise<void>, onUploadSwitchSave: (retrySlot?: string|null) => Promise<void>, onDownloadSwitchSave: (retrySlot?: string|null) => Promise<void>, onResumeSwitchSaveNormalSync: () => Promise<void>, onUploadSave: (retryFilePath?: string|null) => Promise<void>, onDownloadSave: (saveId: number, retrySlot?: string|null) => Promise<void>, onClearStatus: () => void}} GameDetailsSavesSectionProps */
...
export const GameDetailsSavesSection = ({
  ...
  return (
    <>
      ...
      {isSwitch && switchRestoreProtection !== null && (
        <SwitchRestoreProtectionNotice protection={switchRestoreProtection} />
      )}
      {isSwitch && (
        <TextField
          fullWidth
